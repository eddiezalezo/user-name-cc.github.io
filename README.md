...
> **Nota:** este repositorio también contiene el prototipo anterior **Legado Digital** (`backend/`, `frontend/`, `infra/`). Su documentación original se conserva a continuación.
